...
extern "C" int encode_ldpc(FP_Encoder* p_encoder, unsigned char* uchar_in, unsigned char* uchar_out, int in_len_byte)
{
...
extern "C" int decode_ldpc(FP_Decoder* p_decoder, unsigned char* uchar_in, unsigned char* uchar_out, int in_len_bit)
{
...
extern "C" FP_Encoder* create_enc_obj()
{
	//FP_Decoder *ptr;
	//cout << "new FP_Decoder\n";
	//ptr = new FP_Decoder;
	//cout << "the pointer is " << ptr <<endl; 
	return new FP_Encoder;
}

extern "C" void destroy_enc_obj( FP_Encoder* object )
{
  delete object;
}
