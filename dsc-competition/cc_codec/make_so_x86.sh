...
gcc -shared cat_cccodec3.o cat_cccodec3_wrap.o \
	 ...
	 sumsq.o sumsq_port.o 	sumsq_sse2.o sumsq_sse2_assist.o 	sumsq_mmx.o sumsq_mmx_assist.o \
	 cpu_features.o cpu_mode_x86.o fec.o sim.o viterbi27.o viterbi27_port.o viterbi29.o viterbi29_port.o \
