...
swig -python cat_cc_codec3.i
echo "Compiling..."
gcc -fPIC -c cat_cc_codec3.c cat_cc_codec3_wrap.c \
    -I /usr/include/python2.7
gcc -fPIC -c cat_rs_codec.c 
echo "Linking..."
gcc -shared cat_cc_codec3.o cat_cc_codec3_wrap.o cat_rs_codec.o\
